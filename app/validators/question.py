...
class QuestionValidator:
    ...
    def __init__(self, assessment_id: int):
        ...
        self.question_id: int = assessment_id
        self.question: Question | None = None

    async def init_question(self):
        if not self.question:
            self.question = await self.question_service.fetch_question_with_id(self.assessment_id)

    async def validate_question_creator(self, user_id: int):
