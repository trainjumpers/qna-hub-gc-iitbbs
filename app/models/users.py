...
class User(BaseModel):
    ...
    role: UserRole = Field(None, description="User's role - 0 => regular user, 1 => admin")
    ...
    is_active: bool = Field(True, description="Denotes if the user is active at the moment")
